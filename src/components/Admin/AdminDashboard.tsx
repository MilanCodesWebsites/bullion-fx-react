...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ 
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setIsLoading(true);
        const [usersData, transactionsData, userCountRes] = await Promise.all([
          getAllUsers(),
          getAllTransactions(),
        ...
        setUserCount(userCountRes.count ?? usersData.length);
    ...
    <div className="space-y-6 p-4 sm:p-6 animate-fade-in">
      ...
      <div className="text-center sm:text-left">
        <div className="flex items-center justify-center sm:justify-start gap-3 mb-3">
          <img
            src="https://otiktpyazqotihijbwhm.supabase.co/storage/v1/object/public/images/60afbffb-157e-4ab9-8cc5-b77b4db06658-ChatGPT_Image_Oct_11__2025__05_35_01_PM-removebg-preview.png"
            alt="Vertex Logo"
        ...
        <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-800/60 rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex items-center">
            ...
            <div className="ml-3 sm:ml-4">
              ...
              <p className="text-xl sm:text-2xl font-bold text-white">{userCount !== null ? userCount : '—'}</p>
            </div>
          </div>
        </div>
