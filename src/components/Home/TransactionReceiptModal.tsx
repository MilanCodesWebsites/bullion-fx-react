  ...
  return (
      ...
      <div className="bg-black text-white p-4 sm:p-6 rounded-t-lg">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            />
            <span className="text-xl sm:text-2xl font-extrabold">BullionFX</span>
          </div>
          <button
            onClick={onClose}
        ...
        <p className="text-xs sm:text-sm text-white/80">Transaction Receipt</p>
      </div>
    ...
    <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
          ...
          <div className="border-t border-gray-200 pt-4 text-center">
            <p className="text-white mb-2 text-xs sm:text-sm">Thanks for using BullionFX</p>
            <p className="text-xs sm:text-sm text-white/80">
              For support, contact us at support@bullionfx.com
            </p>
          </div>
        </div>
